...
public class MainActivity extends AppCompatActivity
    ...
    public void onMapSearch(View view) {
        ...
        if (location != null || !location.equals("")) {
            ...
            mMap.addMarker(new MarkerOptions().position(latLng).title(getCurrentAddress(currentPosition)));
            mMap.addMarker(new MarkerOptions().position(latLng).title("위도:" + String.valueOf(address.getLatitude())
                    + " 경도:" + String.valueOf(address.getLongitude())));
